...
class TestAirflowJobs(unittest.TestCase):
    ...
    @patch.dict(os.environ, {"AIRFLOW_API_URL": "http://mock-airflow.com",
                             "AIRFLOW_USER": "user",
    ...
    def test_run_sampling_job_success(self, mock_post):
        ...
        with patch.object(job, "_AirflowJobs__run_airflow_job", return_value="1234") as mock_airflow:
    ...
    def test_run_fine_tuning_job_success(self, mock_post):
        ...
        with patch.object(job, "_AirflowJobs__run_airflow_job", return_value="5678") as mock_airflow:
